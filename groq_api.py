...
def prepare_groq_messages(
    ...
    if not base64_images:
        ...
        groq_messages.extend(build_base_messages(None, messages))
    else:
        # Skip system when images present - iterate history manually
    ...
    if base64_images:
        groq_messages.append(build_multimodal_user_message(user_message, base64_images, image_format="openai"))
